...
class GPT(nn.Module):
    ...
    def forward(self, idx, targets=None, infer_last_only=True):
        device = idx.device
        b, t = idx.size()
    ...
    def generate(self,
        ...
        for _ in range(max_new_tokens):
            ...
            logits = self.get_last_logits(idx_cond, temperature, top_k, top_p)
